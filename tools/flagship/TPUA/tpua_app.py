...
class TPUAApp(QMainWindow):
    ...
    def show_legacy_info(self):
        ...
        msg.setText(
            ...
            "These scripts expect the font to have F700 characters. If your game doesn't have such a script, use the standard TPUA Font Generator instead."
        )
        msg.exec()
